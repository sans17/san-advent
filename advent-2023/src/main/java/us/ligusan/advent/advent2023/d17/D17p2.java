...
public class D17p2 {
    ...
    public static void main(final String[] args) {
        try (var scanner = new Scanner(D17p2.class.getResourceAsStream("input.txt"))) {
...
//                    System.out.format("point=%s\n", point);
                    ...
                    return Map.entry(newPath.subList(0, i), newPath.size());
                }).filter(newPathWithSize -> {
                    final var newPath = newPathWithSize.getKey();
                    final var pathSizeWithTurn = newPathWithSize.getValue();
                    return pathSizeWithTurn == newPath.size() || pathSizeWithTurn > 5;
...
//                newPaths = newPaths.stream()
                    ...
                    final var newPathSize = newPath.size();
                    return newPath0.x() == 0 && newPath0.y() == 0 ? newPathSize > 4 && newPathSize < 11 : newPathSize < 12;
